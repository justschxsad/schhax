...
(function (qc) {
	...
	function Sb() {
		this.xc = 0;
		this.ab = [];
		this.Ar = new R(["Süre Doldu"], 16777215);
		this.Gq = new R(["Süre Doldu"],
			15035990);
		this.Fq = new R(["GOOOOOOOL"], 15035990);
		this.Cn = new R(["GOOOOOOOL"], 625603);
		this.Bn = new R(["GOOOOOOOL"], 625603);
		this.eq = new R(["Oyun", "Durduruldu"], 16777215)
	}
	...
	Sa.prototype = {
		...
		Ro: function (a, b, c, d, e, f) {
			...
			else if (this.th.has(b)) this.sf(a,
				4102);
			else {
	...
	w.uo = function (a, b, c) {
		...
		else if (2097152 > a) b.setUint8(c, a >> 18 & 7 | 240), b.setUint8(c + 1, a >> 12 & 63 | 128), b.setUint8(c + 2, a >> 6 & 63 | 128),
			b.setUint8(c + 3, a & 63 | 128), c += 4;
	...
	V.prototype = C(yb.prototype, {
		...
		gm: function (a) {
			this.rd = this.Ac * (-200 > a ? -200 : 1000 < a ? 1000 : a)
		},
		f: V
	});
		...
		gf: function (a) {
			...
			switch (c) {
				...
				case "colors":
					...
					break;
				case "extrapolation":
					2 == a.length ? (a = K.parseInt(a[1]), null != a && -200 <= a && 1000 >= a ? (n.A.rd.Xa(a), this.ya.gm(a), this.ba("Extrapolation set to " + a + " msec")) : this.ba("Extrapolation must be a value between -200 and 50 milliseconds")) : this.ba("Extrapolation requires a value in milliseconds.");
					break;
				case "handicap":
		...
		C: function (a) {
			if (0 < this.Oa) 120 > this.Oa && this.Oa--;
				...
				if (0 == this.Bb) {
					...
					this.Da && this.Pb != this.Kb ? this.um() : (this.Gk(), null != this.Ma.lq && this.Ma.lq()));
			...
			if (null != b && null != a) {
				...
				if (!(0 >= f)) {
					...
					if (this.Hb >= this.ec) g = this.Hb, k = 0;
						...
						this.Hb) g = this.Hb, k = 1;
					else if (f >= this.ec) g = this.ec, k = -1;
					else return;
					f = g - f;
					if (0 == 0 * this.ne) d = this.ne * f * .5, e *= d, c *= d, k = d = b.D, b = b.aa, d.x = k.x + e * b, d.y = k.y + c * b, d = b = a.D, a = a.aa, b.x = d.x + -e * a, b.y = d.y + -c * a;
					else {
						g = f * d;
						var l = b.a,
							h = b.a;
			...
			for (b = this.F.length; a < b;) {
				...
				if (0 != c.aa) {
					...
					for (e = this.J; d < e.length;)
						if (f = e[d], ++d, 0 != (f.h & c.v) && 0 != (f.v & c.h) && (k = c.a, l = f.a, g = k.x - l.x, k = k.y - l.y, l = g * g + k * k, 0 < l && l <= c.Z * c.Z)) {
							var l = Math.sqrt(l),
								g = g / l,
								k = k / l,
								l = c.Z - l,
	...
	N.prototype = {
		...
		Lq: function (a, b, c) {
			var d = a.K;
			if (null != d)
				for (d = d.ta.F[0], this.nk(d.a, d.R, b, c), d = 0, a = a.I; d < a.length;) {
					var e = a[d];
					++d;
	...
	Da.prototype = {
		...
		Ok: function (a) {
			var b = this.dc.clientHeight,
				b = this.dc.scrollTop + b - this.dc.scrollHeight >= .5 * -b || !Da.Yo(this.dc);
	...
	R.jn = new Ib([0, 0, 2, 1, 0, .35, 1, 0, 1, 0, .7, 1, 0, 0,
		0, 1
	]);
